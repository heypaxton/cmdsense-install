...
import pypozyx.definitions.registers
import time
import json
import requests
...
class ReadyToLocalize(object):
    ...
    def setup(self):
        ...
        anchor_list = [0x6001, 0x606B, 0x604E, 0x6049]
        #print('calibration starting!')
        #calibration = self.pozyx.doAnchorCalibration(self.dimension, 1, anchor_list, self.remote_id)
    ...
    def printPublishPosition(self, position):
        ...
        if network_id is None:
            network_id = 0
        print("POS ID {}, x(mm): {pos.x} y(mm): {pos.y}".format(
...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x6001, 1, Coordinates(0, 0, 0)),
               DeviceCoordinates(0x606B, 1, Coordinates(0, 1734, 0)),
               DeviceCoordinates(0x604E, 1, Coordinates(2556, 1734, 0)),
               DeviceCoordinates(0x6049, 1, Coordinates(2556, 0, 0))]
